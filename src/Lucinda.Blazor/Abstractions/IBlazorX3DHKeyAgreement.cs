// <copyright file="IBlazorX3DHKeyAgreement.cs" company="Lucinda">
...
{
    /// <summary>
    /// Defines the contract for X3DH (Extended Triple Diffie-Hellman) key agreement operations in Blazor.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public interface IBlazorX3DHKeyAgreement
    {
        /// <summary>
        /// Gets the name of the key agreement algorithm.
        /// </summary>
        /// <value>The algorithm name (e.g., "X3DH-P256", "X3DH-P384").</value>
        ...
        /// <returns>
        /// A task containing a <see cref="BlazorCryptoResult{T}"/> with the X3DH result on success,
        /// or an error message on failure.
        /// </returns>
        /// <remarks>
        /// The initiator generates an ephemeral key pair internally and includes the public key in the result.
        /// </remarks>
        Task<BlazorCryptoResult<BlazorX3DHResult>> InitiatorAgreeAsync(
        ...
        /// or an error message on failure.
        /// </returns>
        Task<BlazorCryptoResult<BlazorX3DHResult>> ResponderAgreeAsync(
        ...
        /// <returns>
        /// A task containing a <see cref="BlazorCryptoResult{T}"/> with the generated pre-key bundle on success,
        /// or an error message on failure.
        /// </returns>
        Task<BlazorCryptoResult<BlazorPreKeyBundleWithPrivateKeys>> GeneratePreKeyBundleAsync(
